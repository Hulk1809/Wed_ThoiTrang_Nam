...
export default function BlogIndexPage({ posts }: InferGetStaticPropsType<typeof getStaticProps>) {
  return (
    <Page
      title="Bài Viết — Tin tức và bài phân tích"
      description="Tin tức công nghệ AI, nội dung Marketing và xu hướng truyền thông số. Cập nhật bài viết nổi bật và mới nhất từ Kapendt Lab."
    >
      <CustomAutofitGrid>
